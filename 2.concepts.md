...
Impact Framework imposes **a minimum of constraints** on its users, balancing standards that ensure plugin interoperability with the freedom for expression and creativity in defining and measuring impacts. 
...
These principles are further explained in the [Design philosophy](https://if.greensoftware.foundation/major-concepts/design-philosophy) documentation.
...
For more information, refer to the [IMP File documentation](https://if.greensoftware.foundation/major-concepts/imp-file).
...
In this module, we learnt some core essential concepts in Impact Framework. Understanding these terms is crucial as we will be using them extensively throughout the rest of the course.
