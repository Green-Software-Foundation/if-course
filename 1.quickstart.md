...
Navigate to the folder where `output-file.yml` lives and start a simple HTTP server:
...
This will serve your file at `http://localhost:8080/output-file.yml`. Then:

1. Open your browser and navigate to: `https://viz.if.greensoftware.foundation`
2. In the visualizer, enter the URL: `http://localhost:8080/output-file.yml`
