...
> [!NOTE] 
> An **impact** or an **impact dependency** is something we need to compute, an **observation** is something we will **use** in a computation. Since energy is an observation it also means it's a leaf in our impact dependency tree. I like to visually denote an observation with 🌿 to distinguich between an impact/dependency.
