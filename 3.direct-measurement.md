...
Now we have an understanding of the basics of IF and IMPs, lets walks you through a simple IMP that converts energy consumption into carbon emissions using the built‑in `Multiply` plugin.
