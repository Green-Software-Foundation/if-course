...
- Understand the two key plugins in the Impact Framework standard library `Sci` and `SciEmbodied`.
...
You can add these values to the defaults of a component like so:
