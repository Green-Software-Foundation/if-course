...
This module covers the first two phases. The next module covers execution.
...
- The IDOMI process you learned in modules 3–6e scales naturally to complex, multi-component applications.
